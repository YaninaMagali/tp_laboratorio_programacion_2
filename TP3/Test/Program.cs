...
namespace Test
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if(new RecetaCerveza(ETipoCerveza.IPA, 2)!= null)
            {
            ...
            CervezaIPA ipa = new CervezaIPA(new RecetaCerveza(ETipoCerveza.IPA, 1));
            CervezaKolsh kolsh = new CervezaKolsh(new RecetaCerveza(ETipoCerveza.Kolsh, 1));
            listaBirra.Add(ipa);
